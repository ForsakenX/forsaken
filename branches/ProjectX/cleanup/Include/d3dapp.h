 ...
 * $Revision: 10 $
 *
 * $Header: /PcProjectX/Include/d3dapp.h 10    5/20/97 2:20p Phillipd $
 *
 * $Log: /PcProjectX/Include/d3dapp.h $
 * 
 * 10    5/20/97 2:20p Phillipd
 * 
 * 9     5/16/97 10:06a Phillipd
 * 
 * 8     1/10/97 11:30a Phillipd
 * movies are now doable
 * 
 * 7     10/24/96 3:01p Phillipd
 * 
 * 6     10/23/96 4:23p Phillipd
 * Lots of crap taken out of D3dapp and its associated functions and
 * files....
 * 
 * 5     9/17/96 11:26a Phillipd
 * 
 * 4     8/21/96 3:57p Phillipd
 * 
 * 3     8/03/96 4:39p Phillipd
