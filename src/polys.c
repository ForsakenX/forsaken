...
FILE * SavePolys( FILE * fp )
{
	...
	if( fp )
	{
		...
		while( i != (u_int16_t) -1 )
		{
			...
			fwrite( &Polys[ i ].Col1, sizeof( RGB ), 1, fp );
			fwrite( &Polys[ i ].Col2, sizeof( RGB ), 1, fp );
			fwrite( &Polys[ i ].Col3, sizeof( RGB ), 1, fp );
			fwrite( &Polys[ i ].Col4, sizeof( RGB ), 1, fp );
...
FILE * LoadPolys( FILE * fp )
{
	...
	if( fp )
	{
		...
		while( i != (u_int16_t) -1 )
		{
			...
			fread( &Polys[ i ].Col1, sizeof( RGB ), 1, fp );
			fread( &Polys[ i ].Col2, sizeof( RGB ), 1, fp );
			fread( &Polys[ i ].Col3, sizeof( RGB ), 1, fp );
			fread( &Polys[ i ].Col4, sizeof( RGB ), 1, fp );
