...
#define YOU "Sie"
#define GOT_CAUGHT_WITH_A_BOMB "wurden mit einer Bombe erwischt"
...
#define YOU_HAVE_GOT_A_NEW_BOMB "Sie haben eine neue Bombe"
...
// oct2.c
#define A_BOMB_KILLED_YOU				"Eine Bombe hat Sie erledigt..."
