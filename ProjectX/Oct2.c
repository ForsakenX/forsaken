 ...
 * 
 * 721   15/01/98 17:23 Oliverc
 * Temporarily disabled demo_levels[] for SHAREWARE
 * 
 ...
 * 
 * 667   19/12/97 17:56 Oliverc
 * Disabled remote camera for SHAREWARE
 * 
 ...
 * 
 * 654   12/12/97 15:35 Oliverc
 * Disabled some more in-game keys for PCIDENT version
 * 
 ...
 * 
 * 542   15/09/97 10:44 Oliverc
 * Disabled more keys in SELF_PLAY mode
 * 
 ...
 * )
 * 
 * 512   12/08/97 10:14 Oliverc
 * Text info now defaults to ON for normal game, but OFF for SELF_PLAY
 * mode
 * 
